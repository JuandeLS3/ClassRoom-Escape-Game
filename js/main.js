    ...
    $(".item").droppable({
      drop: function(event, ui) {
        //$(this)
        	...
        	if (item == "router") {
        		$("#lapista").text("Router: hardware que permite la interconexión entre dispositivos y nos facilita internet");
        	}
        	if (item == "cable") {
        	...
        	if (item == "navegador") {
        		$("#lapista").text("Navegador: software que nos permite “navegar” por la red");
        	}
      }
    });
    });
